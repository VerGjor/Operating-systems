...
public class TancSoStudentite {
	...
	static Semaphore gymCapacity ,mDressingRoom, fDressingRoom, startDancing;
	static int count = 0;
 
    public void init() {
        //TODO: da se implementira
    	gymCapacity = new Semaphore(3);
    	mDressingRoom = new Semaphore(10);
    	fDressingRoom = new Semaphore(10);
    	startDancing  = new Semaphore(0);
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
        	mDressingRoom.acquire();
        	show.presobleci();
        	mDressingRoom.release();
        	
            // samo maskoto go povikuva metodot tancuvaj  
        	gymCapacity.acquire();
        	startDancing.acquire();
        	show.tancuvaj();
        	gymCapacity.release();
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
        	fDressingRoom.acquire();
        	show.presobleci();
        	fDressingRoom.release();
        	
        	startDancing.release();
        }
